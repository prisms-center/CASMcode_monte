...
#include "casm/monte/calculators/complete_semigrand_canonical.hh"
#include "gtest/gtest.h"
#include "testdir.hh"

using namespace CASM;
using namespace CASM::monte::models::basic_ising_eigen;
using namespace CASM::monte::calculators::complete_semigrand_canonical;
...
TEST(CompleteIsingEigenTest, IsingConfiguration1) {
  Eigen::VectorXi shape(2);
  shape << 25, 25;
  int fill_value = 1;
  IsingConfiguration configuration(shape, fill_value);
...
TEST(CompleteIsingEigenTest, SemiGrandCanonicalConditions1) {
  typedef SemiGrandCanonicalConditions conditions_type;
...
TEST(CompleteIsingEigenTest, SemiGrandCanonicalIsingState1) {
...
TEST(CompleteIsingEigenTest, IsingSemiGrandCanonicalEventGenerator1) {
...
TEST(CompleteIsingEigenTest, IsingFormationEnergy1) {
...
TEST(CompleteIsingEigenTest, IsingComposition1) {
  ...
  int fill_value = 1;
  state_type state = testing::make_complete_Ising_default_state(25, 25, fill_value);
...
TEST(CompleteIsingEigenTest, SemiGrandCanonicalPotential1) {
  /// Construct a state to calculate the semi-grand canonical energy of
  int fill_value = 1;
  double temperature = 2000.0;
  double mu = 2.0;
  state_type state =
      testing::make_complete_Ising_default_state(25, 25, fill_value, temperature, mu);
...
TEST(CompleteIsingEigenTest, SemiGrandCanonicalRun1) {
  /// Construct a state to calculate the semi-grand canonical energy of
  int fill_value = 1;
  double temperature = 2000.0;
  double mu = 0.0;
