...
//   results.stats = stats;
//   results.requested_precision = requested_precision;
//   result.is_converged = get_calculated_precision(stats) <
//   requested_precision; return result;
// }
//
//
...
//       current =
//       convergence_check(calc_statistics_f(sampler.component(key.component_index).tail(results.N_samples_for_statistics),
...
//       Index i_weight = sampler.n_samples() -
//       results.N_samples_for_statistics; for (Index i = 0; i <
//       weighted_observations.size(); ++i, ++i_weight) {
//         weighted_observations(i) *= weight_factor * sample_weight[i_weight];
//       }
//       current = convergence_check(calc_statistics_f(weighted_observations,
//       confidence), precision);
//     }
//
//     // combine results
